...
do_compile () {
	...
	# bootparameter ${WORKDIR}/recipe-sysroot/boot/u-boot-mys-rzg2l-2021.10-r0.bin bl2_bp.bin
	# cat ${WORKDIR}/recipe-sysroot/boot/u-boot-mys-rzg2l-2021.10-r0.bin >> bl2_bp.bin
