...
.. csv-table:: 
   :header: "软件名","子包","oct名称","功能说明","详细情况","依赖"
   ...
   "kexec-tools",	"kexec-2.0.23-r0.aarch64.rpm",	"kexec",	"重新启动新内核的快速重新引导功能部件",	"提供kexec工具，促进新的内核在正常或恐慌重启中使用内核的kexec特性来重启。",	"glibc >= 2.34;libz1 >= 1.2.11"
   ...
   "kernel",	"kernel-module-ip6-tables-5.10-r0.armv7l.rpm（仅arm有）",	"kernel-module-ip6-tables",	"内核模块ip6_tables",	"提供内核模块ip6_tables",	"/bin/sh;kernel-5.10.0;kernel-module-x-tables"
   "kernel",	"kernel-module-ip6table-filter-5.10-r0.armv7l.rpm（仅arm有）",	"kernel-module-ip6table-filter",	"内核模块ip6table_filter",	"提供内核模块ip6table_filter",	"kernel-5.10.0;kernel-module-ip6-tables;kernel-module-x-tables"
   ...
   "kernel",	"kernel-module-nf-conntrack-5.10-r0.armv7l.rpm（仅arm有）",	"kernel-module-nf-conntrack",	"内核模块nf_conntrack",	"提供内核模块nf_conntrack",	"/bin/sh;kernel-5.10.0;kernel-module-nf-defrag-ipv4"
   "kernel",	"kernel-module-nf-defrag-ipv4-5.10-r0.armv7l.rpm（仅arm有）",	"kernel-module-nf-defrag-ipv4",	"内核模块nf_defrag_ipv4",	"提供内核模块nf_defrag_ipv4",	"/bin/sh;kernel-5.10.0"
   "kernel",	"kernel-module-nf-defrag-ipv6-5.10-r0.armv7l.rpm（仅arm有）",	"kernel-module-nf-defrag-ipv6",	"内核模块nf_defrag_ipv6",	"提供内核模块nf_defrag_ipv6",	"/bin/sh;kernel-5.10.0"
   "kernel",	"kernel-module-nf-nat-5.10-r0.armv7l.rpm（仅arm有）",	"kernel-module-nf-nat",	"内核模块nf_nat",	"提供内核模块nf_nat",	"/bin/sh;kernel-5.10.0;kernel-module-nf-conntrack"
   ...
   "kernel",	"kernel-module-oid-registry-5.10-r0.aarch64.rpm (仅aarch64有)",	"kernel-module-oid-registry",	"内核模块oid_registry(aarch64)",	"提供内核模块oid_registry",	"/bin/sh;kernel-5.10.0"
