...
SRC_URI += " \
        ...
        file://procps-ng/0001-add-M-and-N-options-for-top.patch \
        file://procps-ng/0002-top-exit-with-error-when-pid-overflow.patch \
        file://procps-ng/0003-top-eliminate-a-potential-abend-when-exiting-A-mode.patch \
        "
